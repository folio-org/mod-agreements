...
public class PolicyIdsResponse {
   ...
   */
  @Nullable
  final List<AccessPolicyTypeIds> readPolicyIds;
  /**
   ...
   */
  @Nullable
  final List<AccessPolicyTypeIds> updatePolicyIds;
  /**
   ...
   */
  @Nullable
  final List<AccessPolicyTypeIds> createPolicyIds;
  /**
   ...
   */
  @Nullable
  final List<AccessPolicyTypeIds> deletePolicyIds;
  /**
   ...
   */
  @Nullable
  final List<AccessPolicyTypeIds> claimPolicyIds;
  /**
   ...
   */
  @Nullable
  final List<AccessPolicyTypeIds> applyPolicyIds;
}
