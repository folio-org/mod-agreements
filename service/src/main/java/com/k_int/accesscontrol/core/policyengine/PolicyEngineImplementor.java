...
public interface PolicyEngineImplementor {
   ...
   */
  List<GroupedExternalPolicyList> getRestrictionPolicies(String[] headers, PolicyRestriction pr);
   ...
   */
  boolean arePoliciesValid(String[] headers, PolicyRestriction pr, List<GroupedExternalPolicyList> policies);
   ...
   */
  List<GroupedExternalPolicyList> enrichPolicies(String[] headers, List<GroupedExternalPolicyList> policies);
}
