 ...
 * <p>
 * This class is used to encapsulate a collection of {@link GroupedExternalPolicyList},
...
public class PoliciesFilter {
  /**
   * A list of {@link GroupedExternalPolicyList} to be used as filters.
   * Each entry in the list represents a group of access policies
   * that will be ORed together in a filter operation.
   * @param filters A list of {@link GroupedExternalPolicyList} to be used as filters.
   * @return A list of {@link GroupedExternalPolicyList} to be used as filters.
   */
  @Getter
  List<GroupedExternalPolicyList> filters;

  /** Constructor for PoliciesFilter.
   * @param filters A list of {@link GroupedExternalPolicyList} to be used as filters.
   */
  public PoliciesFilter(List<GroupedExternalPolicyList> filters) {
  ...
  public static PoliciesFilter fromString(String policyString) {
    return new PoliciesFilter(
      GroupedExternalPolicyList.fromString(policyString)
    );
  }

  /** Create a list of PoliciesFilter from a collection of string representations of policies.
   * These top level filters will be ANDed together in a filter operation, with the internal list of {@link GroupedExternalPolicyList} being
