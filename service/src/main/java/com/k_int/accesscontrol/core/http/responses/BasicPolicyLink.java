 ...
 * an associated {@link IExternalPolicy}, including its identifier, type, and human-readable description.
 * </p>
 *
 * <p>
...
public class BasicPolicyLink implements PolicyLink {
  ...
  /**
   * The {@link IExternalPolicy} object associated with this link.
   * This links the resource to a specific access policy.
   * @param policy The policy
   * @return The policy
   */
  IExternalPolicy policy;
